  ...
  void _calculateScore() {
    try {
      ...
      if (controller.currentSpeakingPart.value == 1) {
        ...
        correctText = controller.speakingTopicData.value.paragraph.toLowerCase();
      }
      ...
      controller.pronunciationScore.value = score.round() as double; // Làm tròn thành số nguyên
